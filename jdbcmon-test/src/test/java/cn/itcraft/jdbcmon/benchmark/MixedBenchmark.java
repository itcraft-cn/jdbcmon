...
public class MixedBenchmark {
    ...
    public void tearDownIteration() throws Exception {
        if (directQueryPS != null) directQueryPS.close();
        if (proxiedQueryPS != null) proxiedQueryPS.close();
        if (directUpdatePS != null) directUpdatePS.close();
        if (proxiedUpdatePS != null) proxiedUpdatePS.close();
