...
JAVA_HOME="/home/helly/lang/jdk8"
MVN="mvn"
...
echo "========================================"
echo "Running benchmarks with JDK 8"
echo "========================================"

echo ""
echo "[1/3] Building all modules..."
$MVN clean package -Pjdk8 -DskipTests -q 2>/dev/null
...
$MVN test-compile -Pjdk8 -q 2>/dev/null

echo ""
echo "[3/3] Running benchmarks..."
echo ""

CP="target/test-classes:../jdbcmon-core/target/jdbcmon-core-1.0.0-SNAPSHOT.jar:target/dependency/*"
