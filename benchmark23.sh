...
JAVA_HOME="/home/helly/lang/jdk23"
MVN="mvn"
...
echo "========================================"
echo "Running benchmarks with JDK 23"
echo "========================================"

echo ""
echo "[1/3] Building all modules..."
$MVN clean package -Pjdk23 -DskipTests -q 2>/dev/null
...
$MVN test-compile -Pjdk23 -q 2>/dev/null
